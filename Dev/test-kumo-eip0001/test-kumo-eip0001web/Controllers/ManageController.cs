...
{
    [Authorize]
    public class ManageController : KumoBaseController
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var currentUser = accountService.GetAllUsers().Where(u => u.Id == userId).FirstOrDefault();
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            var user = await UserManager.FindByIdAsync(User.Identity.GetUserId());
            var isPasswordValid = await UserManager.CheckPasswordAsync(user, model.NewPassword);
            if (isPasswordValid)
            {
