...
using Kumo.Entities.Models.Mapping;
using Repository.Pattern.Ef6;
using Microsoft.AspNet.Identity.EntityFramework;

namespace Kumo.Entities.Models
{
    public partial class KumoContext : DataContext
    {
        static KumoContext()
        {
            Database.SetInitializer<KumoContext>(null);
        }

        public KumoContext()
            : base("Name=KumoContext")
        {
        }
        public static KumoContext Create()
        {
